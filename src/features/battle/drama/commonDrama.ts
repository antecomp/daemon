...
const COMMON_OPPONENT_MOVE_DRAMAS: Drama = {
    ...
    'opp-mirror': {
        ...
        run: ({ requestOverlayAnimation }) => {
            ...
            return requestOverlayAnimation('mirror');
        }
    },
...
const COMMON_PLAYER_MOVE_DRAMAS: Drama = {
    // TODO Slash
    'player-slash': {
        place: PLACES.CLASH_ONE,
...
const COMMON_DRAMAS: Drama = { ...COMMON_OPPONENT_MOVE_DRAMAS, ...COMMON_PLAYER_MOVE_DRAMAS };
export default COMMON_DRAMAS;