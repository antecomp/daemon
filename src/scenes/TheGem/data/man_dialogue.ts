...
root.chainAlt( // Chain alternate just takes two speakers and a bunch of strings, and alternates who's speaking.
    ...
    .addCarBranch(
        ['Ask a technical question', 'Is it disabling my daemonveil entirely? Sounds suicidal.'],
    ...
    .addCarBranch(
        ...
        i => i
            ...
            .then("Asuracom doesn't even bail out their own - company policy, or so I've heard.")
    )
    .addBranch(
        ['Say Nothing', '...'],
