...
const DitherShader = {
  ...
  float clusteredDotMatrix[16];
  clusteredDotMatrix[0] = 12.0; clusteredDotMatrix[1] = 5.0;  clusteredDotMatrix[2] = 6.0;  clusteredDotMatrix[3] = 13.0;
  clusteredDotMatrix[4] = 4.0;  clusteredDotMatrix[5] = 0.0;  clusteredDotMatrix[6] = 1.0;  clusteredDotMatrix[7] = 7.0;
  clusteredDotMatrix[8] = 11.0; clusteredDotMatrix[9] = 3.0;  clusteredDotMatrix[10] = 2.0; clusteredDotMatrix[11] = 8.0;
  clusteredDotMatrix[12] = 15.0; clusteredDotMatrix[13] = 10.0; clusteredDotMatrix[14] = 9.0; clusteredDotMatrix[15] = 14.0;

  // Flatten 2D index to access Bayer matrix
  int index = int(coord.x) + int(coord.y) * 4;

  // Normalize threshold to 0.0 - 1.0 range
  return clusteredDotMatrix[index] / 16.0;
  }
